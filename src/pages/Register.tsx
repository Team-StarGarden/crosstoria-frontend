...
import { BtnWrapper } from '../components/Button/BtnWrapper';
...
export const Register: React.FC = () => {
  return (
    <React.Fragment>
      <BtnWrapper position="top-left" padding="x-small"><Button size="large"><icons.ArrowLeft /></Button></BtnWrapper>
      <form css={css`width: calc(100% - 2 * ${styles.SPACE_XXL}); max-width: 272px;`}>
        <h1 css={css`${styles.TEXT_XL}; text-align: center;`}>가입 신청</h1>
        <h2 css={css`${styles.TEXT_L}; text-align: center;`}>연합원 기본 정보 입력</h2>
        <TextInput id="" type="email" placeholder="email@example.com" width="100%" css={css`margin-top: 0;`}/>
